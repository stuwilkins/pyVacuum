...
#
# Created: Wed Oct 27 13:50:23 2010
...
class Ui_AxesDialog(object):
    def setupUi(self, AxesDialog):
        AxesDialog.setObjectName("AxesDialog")
        ...
        self.AutoRangeCheckBox_1.setObjectName("AutoRangeCheckBox_1")
        ...
        self.MinLineEdit_1.setObjectName("MinLineEdit_1")
        ...
        self.MaxLineEdit_1.setObjectName("MaxLineEdit_1")
        ...
        self.LinRadioButton_2.setObjectName("LinRadioButton_2")
        ...
        self.MinLineEdit_2.setObjectName("MinLineEdit_2")
        ...
        self.LogRadioButton_2.setObjectName("LogRadioButton_2")
        ...
        self.MaxLineEdit_2.setObjectName("MaxLineEdit_2")
        ...
        self.AutoRangeCheckBox_2.setObjectName("AutoRangeCheckBox_2")
        self.label_4 = QtGui.QLabel(self.groupBox_2)
        self.label_4.setGeometry(QtCore.QRect(20, 70, 61, 17))
        self.label_4.setObjectName("label_4")

        self.retranslateUi(AxesDialog)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL("accepted()"), AxesDialog.accept)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL("rejected()"), AxesDialog.reject)
        QtCore.QObject.connect(self.AutoRangeCheckBox_1, QtCore.SIGNAL("toggled(bool)"), self.MaxLineEdit_1.setDisabled)
        QtCore.QObject.connect(self.AutoRangeCheckBox_1, QtCore.SIGNAL("toggled(bool)"), self.MinLineEdit_1.setDisabled)
        QtCore.QObject.connect(self.AutoRangeCheckBox_2, QtCore.SIGNAL("toggled(bool)"), self.MaxLineEdit_2.setDisabled)
        QtCore.QObject.connect(self.AutoRangeCheckBox_2, QtCore.SIGNAL("toggled(bool)"), self.MinLineEdit_2.setDisabled)
